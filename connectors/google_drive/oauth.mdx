...
![GoogleDriveEnableAPI](/images/connectors/google_drive/GoogleDriveEnableAPI.png)
    ...
    **Important**: If you plan on using permission syncing for this connector, the account performing the OAuth flow must have an Admin role in the Google Workspace that has access to the "Groups > Read" privilege.
